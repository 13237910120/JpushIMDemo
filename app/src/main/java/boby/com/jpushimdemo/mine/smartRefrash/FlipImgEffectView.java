package boby.com.jpushimdemo.mine.smartRefrash;
...
/**
 * Created by boby on 2017/11/18 0018.
 */
...
public class FlipImgEffectView extends View {
    ...
    public FlipImgEffectView(Context context, @Nullable AttributeSet attrs) {
        super(context, attrs);
        initData(context);
    }

    public FlipImgEffectView(Context context, @Nullable AttributeSet attrs, int defStyleAttr) {
    ...
    private void initData(Context context){
        ...
        showBmp = BitmapFactory.decodeResource(context.getResources(), android.R.mipmap.sym_def_app_icon);
